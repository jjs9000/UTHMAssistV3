<div class="container mx-auto p-4">
    <div class="py-4 mx-auto max-w-2xl justify-items-center">
        <h2 class="text-3xl font-semibold text-center sm:text-left">Saved Task</h2>
    </div>
    @if ($noBookmarkAvailable)
        <div class="flex flex-col rounded-lg p-6 text-center justify-center items-center">
            ...
            <img src="{{ asset('svg/illustration/bookmark-page.svg') }}" alt="Job Illustration" class="w-64 h-auto mt-4">
        </div>
    @else
    <div class="py-4 mx-auto max-w-2xl justify-items-center">
        @foreach ($bookmarks as $bookmark)
            <div class="relative mb-4">
                ...
                <div class="absolute top-0 right-0 mt-2 mr-2">
                    <button onclick="toggleDropdown({{ $bookmark->taskPosting->id }})" class="relative">
                    ...
                    <div id="dropdown-{{ $bookmark->taskPosting->id }}" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10">
