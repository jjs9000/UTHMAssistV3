        ...
        <div class="flex items-center justify-start space-x-4">
            ...
            <div class="flex items-center space-x-2">
                @if ($editingField === 'state')
                    <x-text-input type="text" wire:model="state" class="border rounded-md p-2"></x-text-input>
                    <button wire:click="save" class="text-blue-500 hover:text-blue-700">Save</button>
                @else
                    <span>{{ $state }}</span>
        ...
        <div class="flex items-center justify-start space-x-4">
            ...
            <div class="flex items-center space-x-2">
                @if ($editingField === 'city')
                    <x-text-input type="text" wire:model="city" class="border rounded-md p-2"></x-text-input>
                    <button wire:click="save" class="text-blue-500 hover:text-blue-700">Save</button>
                @else
                    <span>{{ $city }}</span>
        ...
        <div class="flex items-center justify-start space-x-4">
            ...
            <div class="flex items-center space-x-2">
                @if ($editingField === 'post_code')
                    <x-text-input type="text" wire:model="post_code" class="border rounded-md p-2"></x-text-input>
                    <button wire:click="save" class="text-blue-500 hover:text-blue-700">Save</button>
                @else
                    <span>{{ $post_code }}</span>
