<div class="w-1/2 mx-auto p-6 bg-white rounded-lg shadow-lg mt-10">
    ...
    <div class="mt-4">
        @if ($isEditing)
            <x-textarea-input wire:model="bio" class="w-full h-32 p-2 border rounded-md shadow-sm"></x-textarea-input>
        ...
        @else
            <p class="p-2 bg-gray-100 border rounded-md truncate">{{ $bio }}</p>
            <div class="flex justify-end mt-2">
