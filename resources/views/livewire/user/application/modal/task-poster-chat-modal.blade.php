<div class="bg-white rounded-lg shadow-lg p-8 max-w-lg w-full relative">
    ...
    @if ($hasName)
        ...
        @if ($isApplicantConnected)
            <p class="font-semibold bg-gray-900 text-white text-center border-2 rounded-lg shadow-md mb-4 p-4">{{ $applicantName }} is connected to chat <img src="{{ asset('svg/circle-online-icon.svg') }}" alt="Online" class="w-4 h-4 inline-block"></p>
        @else
