...
class ApplicantChatModal extends ModalComponent
{
    ...
    public function loadNames()
    {
        ...
        if ($application) {
            ...
            $this->isTaskPosterConnected = !empty($application->task->user->name);
        }
    }
    ...
    {
        return view('livewire.user.application.modal.applicant-chat-modal');
    }
}
